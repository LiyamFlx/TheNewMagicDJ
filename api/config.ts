...
export const apiConfig = {
  ...
  SUPABASE_URL: readEnv('SUPABASE_URL', ['NEXT_PUBLIC_SUPABASE_URL', 'VITE_SUPABASE_URL']),
  SUPABASE_ANON_KEY: readEnv('SUPABASE_ANON_KEY', ['NEXT_PUBLIC_SUPABASE_ANON_KEY', 'VITE_SUPABASE_ANON_KEY']),
